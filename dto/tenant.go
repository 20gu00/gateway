...
func (params *TenantListInput) GetValidParams(c *gin.Context) error {
...
func (params *TenantDetailInput) GetValidParams(c *gin.Context) error {
	return common.ValidDefaultParams(c, params)
}
...
func (params *TenantAddHttpInput) GetValidParams(c *gin.Context) error {
	return common.ValidDefaultParams(c, params)
}
