...
INSERT INTO `admin` VALUES (1,'admin','admin','f6da0c07372854658b17f13b696614989029773bd1457f68225d8b4339e48cec','1971-01-01 00:00:00','2022-10-28 20:13:06',0),(2,'cjq','cjq','e6dbc41d32d5a3f47a1c7216008b4ee5a7b7d2de84284e66e78','1971-01-01 00:00:00','1971-01-01 00:00:00',0);
...
INSERT INTO `service_info` VALUES (429,0,'testrhttp','update','2022-10-25 20:31:45','2022-10-25 20:17:23',0),(431,1,'testtcp','开启测试tcp服务器','2022-10-27 02:26:07','2022-10-25 20:21:12',0);
...
INSERT INTO `service_load_balance` VALUES (526,429,0,0,0,0,'127.0.0.1:80','50','',0,0,0,0),(527,430,0,0,0,0,'127.0.0.1:1001','200','',0,0,0,0),(528,431,0,0,0,0,'127.0.0.1:7002','100','',0,0,0,0),(529,432,0,0,0,0,'127.0.0.1:1001','200','',0,0,0,0);
...
CREATE TABLE `tenant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='网关的租户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tenant` VALUES (11,'tenant_id_a','租户1','449441eb5e72dca9c42a12f3924ea3a2','white_ips',100000,100,'2022-10-21 20:55:02','2022-10-22 07:23:34',0),(12,'tenant_id_b','租户2','8d7b11ec9be0e59a36b52f32366c09cb','',200,0,'2022-10-21 21:40:52','2022-10-22 07:23:27',0),(13,'tenant_id_c','租户3','','',0,0,'2022-10-21 22:02:23','2022-10-22 22:06:51',1),(14,'tenant_id_d','租户4','07d980f8a49347523ee1d5c1c41aec02','',0,0,'2022-10-21 22:06:38','2022-10-22 22:06:49',1),(35,'tenant_1','测试添加租户1','passwd','',0,0,'2022-10-26 16:27:24','2022-10-26 16:27:24',0),(36,'tenant_2','测试添加租户2','44e984cf2dd07f21145c1776d38dd406','',0,0,'2022-10-26 16:27:57','2022-10-26 16:27:57',0);
...
-- Dump completed on 2022-10-28 20:35:30
