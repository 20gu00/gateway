...
import (
	...
	"github.com/20gu00/gateway/tools/tcpProxy/tcpProxyServerMiddleware"
	"io"
	"log"
	"net"
	"time"
...
func NewTcpLoadBalanceReverseProxy(c *tcpProxyServerMiddleware.TcpSliceRouterContext, lb loadBalance.LoadBalance) *TcpReverseProxy {
